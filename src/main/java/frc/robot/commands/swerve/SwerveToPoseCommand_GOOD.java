 ...
 */
public class SwerveToPoseCommand_GOOD extends Command {
     ...
     */
    public SwerveToPoseCommand_GOOD(SwerveSubsystem swerve, Pose2d finalPose) {
        ...
        SmartDashboard.putData("SwerveToPoseCommand", builder -> {
            builder.addDoubleProperty("DistFeet", () -> Units.metersToFeet(meters), null);
            builder.addDoubleProperty("DistDegrees", () -> Units.radiansToDegrees(radians), null);
            builder.addDoubleProperty("SpeedX", () -> Units.metersToFeet(speedX), null);
            builder.addDoubleProperty("SpeedY", () -> Units.metersToFeet(speedY), null);
            builder.addDoubleProperty("SpeedOmega", () -> Units.radiansToDegrees(speedOmega), null);
            builder.addDoubleProperty("ErrorX", () -> Units.metersToFeet(errorX), null);
            builder.addDoubleProperty("ErrorY", () -> Units.metersToFeet(errorY), null);
            builder.addDoubleProperty("ErrorOmega", () -> Units.radiansToDegrees(errorOmega), null);
    ...
    private ChassisSpeeds addFeedbackAndClamp(Pose2d currentPose, Pose2d desiredPose, double speedX, double speedY, double speedOmega) {
        ...
        errorX = desiredPose.getX() - currentPose.getX();
        errorY = desiredPose.getY() - currentPose.getY();
        errorOmega = desiredPose.getRotation().getRadians() - currentPose.getRotation().getRadians();
